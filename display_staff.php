...
<html>
    ...
    <?php include 'header.php' ?>
        ...
        <div class='admin_nav'>
            ...
            <div class="divider">
                <div class="disstaff" style="color:black;margin-left:2em;">
                <h3 style='color:#2E4372;text-align:center;'><u >Staff Details</u></h3>
                <form action="editstaff.php" method="POST" style="width:80%;">
                ...
                <table class="table table-hover" align="center">
                    ...
                    <tbody>
                         ...
                         <div style="margin-left:300px;width:30%;">
                                <input type="submit" name="submit1_id" value="EDIT STAFF DETAILS" class="addstaff_button btn btn-green btn-block btn-flat ">  
                            </div>
                    </div>
                    </div>
