...
<html>
    ...
    <?php include 'header.php' ?>
        ...
        <div class='admin_nav'>
           ...
           <div class="divider">
             <div class="delcust" style="color:black;margin-left:2em;">
            <h3 style='color:#2E4372;text-align:center;'><u >Customer Details</u></h3> 
                 ...
                 <div class="row" id="com_container"> 
                    <div class="col-lg-12 col-md-12 col-sm-12"><br> 
                        ...
                        <div style="margin-left:300px;width:30%;">
                                <input type="submit" name="submit2_id" value="DELETE CUSTOMER DETAILS" class="addstaff_button btn btn-green btn-block btn-flat ">  
                        </div>
                     </div>
                     </div>
                 </form>
