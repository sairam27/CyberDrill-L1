...
<html>
    ...
    <body>
        ...
        <div class='admin_nav'>
            ...
            <div class="divider">
            <div class="discust" style="color:black;margin-left:2em;">
                 ...
                 <table class="table table-hover"  align="center">
                     ...
                     <tbody>
                        ...
                        <div style="margin-left:300px;width:30%;">
                                <input type="submit" name="submit_id" value="EDIT CUSTOMER DETAILS" class="addstaff_button btn btn-green btn-block btn-flat ">  
                            </div>
